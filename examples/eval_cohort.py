"""
Independent Reproducible Evaluation Harness for Velto vs Decision Benchmarks.

Runs 68 standardized decision questions across active backends (velto-fast, velto-multilingual).
Calculates:
...
def run_independent_eval(backend_name: str = "velto-fast"):
...
def main():
    print("=================================================================")
    print("VELTO AI INDEPENDENT REPRODUCIBLE BENCHMARK HARNESS")
    print("=================================================================")
    print(f"Testing {len(TEST_COHORT)} Standardized Decision Cases across backends...")

    run_independent_eval("velto-fast")
    run_independent_eval("velto-multilingual")
